...
class AnyType {
  ...
  generate(dataType, options, orgOptions) {
    const defaultVal = dataType.get('default');
    ...
    const o = this._generateValidationCode(dataType, options, orgOptions);
