...
export function stringReplace(searchValue: any, replacer: any) {
  return validator<string>('stringReplace',
      function (input: unknown): Nullish<string> {
        if (input == null)
          return input;
...
export function stringSplit(splitter: any, limit: any) {
  return validator<string[], string>('stringSplit',
...
export function trim() {
  return validator<string, string>('trim',
      function (input: unknown) {
        if (input == null)
          return input;
...
const trimEndRule =
    validator<string, string>('trimEnd',
        function (input: unknown): Nullish<string> {
          if (input == null)
            return input;
...
const trimStartRule =
    validator<string, string>('trimStart',
        function (input: unknown): Nullish<string> {
          if (input == null)
            return input;
