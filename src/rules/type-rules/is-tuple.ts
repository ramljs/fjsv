 ...
 * @validator isTuple
 */
export function isTuple<T1, I1>(items: [Validator<T1, I1>], options?: ValidationOptions): Validator<[T1], [I1]>;
...
export function isTuple<T1, I1, T2, I2, T3, I3, T4, I4, T5, I5>(
  items: [Validator<T1, I1>, Validator<T2, I2>, Validator<T3, I3>, Validator<T4, I4>, Validator<T5, I5>],
  options?: ValidationOptions,
